...
-- Module: ops@0.1.0
-- Source: modules/ops/build/ops.func.sql
...
END;
$function$;
COMMENT ON FUNCTION ops.get_index() IS 'Page d accueil ops — vue agents avec table dynamique Alpine + terminal';
...
$function$;
COMMENT ON FUNCTION ops.nav_items() IS 'Items de navigation pour le menu pgView — agents en premier (index)';
