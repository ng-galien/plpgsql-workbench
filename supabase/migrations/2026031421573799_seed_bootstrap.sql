-- Bootstrap seed: i18n, tenant, modules, PostgREST pre_request
-- Runs after all DDL + func migrations

-- 1. PostgREST pre_request — sets app.tenant_id from JWT or fallback 'dev'
...
-- 4. Test canvas for illustrator
INSERT INTO document.canvas (id, tenant_id, name, format, orientation, width, height, category)
VALUES ('a09c6e60-df0e-4dfb-83dd-f1c8182687e7', 'dev', 'Test Illustrator', 'A4', 'portrait', 210, 297, 'test')
ON CONFLICT DO NOTHING;
