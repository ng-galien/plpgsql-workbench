...
- Parametres via query string : `/agent?p_module=cad` → `get_agent(p_module text)`
...
- `pg_msg_inbox module:ops` → lire les messages entrants
...
- xterm.js charge depuis CDN (pas de bundler)
