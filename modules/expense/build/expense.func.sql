...
END;
$function$;
COMMENT ON FUNCTION expense.categorie_read(text) IS 'Read a single expense category by id';
...
END;
$function$;
COMMENT ON FUNCTION expense.nav_items() IS 'Navigation items for Expense module with entity mapping';
...
END;
$function$;
COMMENT ON FUNCTION expense.note_read(text) IS 'Read a single expense note with lines and totals — by id or reference';
