...
END;
$function$;
COMMENT ON FUNCTION ledger.post_from_expense(jsonb) IS 'Créer écriture comptable de remboursement note de frais (6xx/4456/421). Brouillon pour review. Une note = une écriture max.';
