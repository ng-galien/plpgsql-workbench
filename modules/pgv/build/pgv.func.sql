...
END;
$function$;
COMMENT ON FUNCTION pgv.route_crud(text,text,jsonb) IS 'CRUD router: dispatch get/set/patch/delete/post to schema functions via URI + pg_proc introspection. Returns jsonb with data + HATEOAS actions.';
