...
END;
$function$;
COMMENT ON FUNCTION pgv.rsql_to_where(text,text,text) IS 'Parse RSQL filter string into safe SQL WHERE clause. Validates columns against schema, type-aware quoting, injection-safe.';
