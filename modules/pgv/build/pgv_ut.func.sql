...
END; $function$;
COMMENT ON FUNCTION pgv_ut.test_api() IS 'Tests pgv.api() — dispatch, HATEOAS, RFC 7807 errors, patch merge';
...
END;
$function$;
COMMENT ON FUNCTION pgv_ut.test_view_schema() IS 'Tests pgv.view_schema() — validates both string and object field formats';
