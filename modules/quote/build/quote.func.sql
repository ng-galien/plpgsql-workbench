...
END;
$function$;
COMMENT ON FUNCTION quote.devis_read(text) IS 'Read devis by id — full detail with client name, totals, and lignes';
...
END;
$function$;
COMMENT ON FUNCTION quote.devis_ui(text) IS 'SDUI view: devis list (table+datasource) and detail (static fields with totals)';
...
END;
$function$;
COMMENT ON FUNCTION quote.facture_read(text) IS 'Read facture by id — full detail with client name, devis ref, totals, and lignes';
...
END;
$function$;
COMMENT ON FUNCTION quote.facture_ui(text) IS 'SDUI view: facture list (table+datasource) and detail (static fields with totals + devis ref)';
