...
END;
$function$;
COMMENT ON FUNCTION quote_ut.test_devis_view_schema() IS 'Test that devis_view() conforms to the _view() JSON Schema contract';
...
END;
$function$;
COMMENT ON FUNCTION quote_ut.test_facture_view_schema() IS 'Test that facture_view() conforms to the _view() JSON Schema contract';
