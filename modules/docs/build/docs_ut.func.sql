...
END;
$function$;
COMMENT ON FUNCTION docs_ut.test_charte_check() IS 'Test charte_check — compliant vs violations';
...
END;
$function$;
COMMENT ON FUNCTION docs_ut.test_get_print() IS 'Test get_print — charte CSS + pages + window.print';
...
END;
$function$;
COMMENT ON FUNCTION docs_ut.test_library_assets() IS 'Test library add/remove assets — upsert role/context';
...
END;
$function$;
COMMENT ON FUNCTION docs_ut.test_page_add_remove() IS 'Test page add/remove — append, remove with renumber, refuse last page';
...
END;
$function$;
COMMENT ON FUNCTION docs_ut.test_page_set_html() IS 'Test page_set_html — HTML saved, revision created, data-id count';
