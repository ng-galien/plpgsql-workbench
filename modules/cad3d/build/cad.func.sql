...
END;
$function$;
COMMENT ON FUNCTION cad.fragment_viewer(integer) IS 'Fragment: 3D viewer with raycaster selection, HUD, info panel. Uses cadViewer Alpine component.';
...
END;
$function$;
COMMENT ON FUNCTION cad.get_drawing_3d(integer) IS 'Page vue 3D d''un dessin. Utilise le fragment cadViewer.';
...
END;
$function$;
COMMENT ON FUNCTION cad.get_drawing_bom(integer) IS 'Page liste de débit (bill of materials) d''un dessin.';
...
END;
$function$;
COMMENT ON FUNCTION cad.page_drawing_3d(integer) IS 'Page vue 3D d''un dessin. Utilise le fragment cadViewer.';
...
END;
$function$;
COMMENT ON FUNCTION cad.get_drawing(integer) IS 'Page dessin 2D: tree + SVG canvas + shapes + formulaire ajout';
...
END;
$function$;
COMMENT ON FUNCTION cad_qa.get_index() IS 'Dashboard QA: stats + viewer 3D + wireframe + BOM';
