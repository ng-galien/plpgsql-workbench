...
BEGIN
  ...
  VALUES
    ...
    ('/images/oenotourisme-3.jpg', 'oenotourisme-3.jpg', 'image/jpeg', 'classified',
     ...
     'Vue drone plongeante sur l''Estafette vert d''eau circulant sur un chemin de terre entre des rangées de vignes d''un vert éclatant.',
    ...
    ('/images/oenotourisme-4.jpg', 'oenotourisme-4.jpg', 'image/jpeg', 'classified',
     ...
     'Citroën 2CV bleue décapotée avec logo My French Tour sur la portière, roulant sur une route entre les vignes.',
    ...
    ('/images/vignoble-aerien.jpg', 'vignoble-aerien.jpg', 'image/jpeg', 'classified',
     ...
     'Magnifique cave voûtée en briques avec deux rangées de tonneaux de chêne alignés. Étiquettes "Meursault" visibles sur les fûts.',
    ...
    ('/images/mickael-portrait.jpg', 'mickael-portrait.jpg', 'image/jpeg', 'classified',
     ...
     'Portrait souriant d''un homme barbu aux yeux bleus. Cheveux relevés en chignon, barbe rousse fournie.',
    ...
    ('/images/bon-cadeau.png', 'bon-cadeau.png', 'image/png', 'classified',
     ...
     'Illustration vintage d''un bon cadeau en forme de billet. Logo My French Tour au centre.',
    ...
    ('/images/balade-vignoble.jpg', 'balade-vignoble.jpg', 'image/jpeg', 'classified',
     ...
     'Femme souriante au volant d''un véhicule vintage, vue intérieur habitacle.',
    ...
    ('/images/tour-2cv-couleur.png', 'tour-2cv-couleur.png', 'image/png', 'classified',
     ...
     'Illustration vectorielle détaillée d''une Citroën 2CV bleu ciel vue de profil sur fond blanc.',
