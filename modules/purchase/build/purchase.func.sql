...
END;
$function$;
COMMENT ON FUNCTION purchase.commande_read(text) IS 'Read commande by id with fournisseur name and totals';
...
END;
$function$;
COMMENT ON FUNCTION purchase.facture_fournisseur_read(text) IS 'Read facture fournisseur by id with commande and fournisseur info';
