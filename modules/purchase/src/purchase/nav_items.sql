...
BEGIN
  RETURN jsonb_build_array(
    ...
    jsonb_build_object('href', '/commande', 'label', pgv.t('purchase.nav_commandes'), 'icon', 'shopping-cart', 'entity', 'commande'),
    jsonb_build_object('href', '/facture_fournisseur', 'label', pgv.t('purchase.nav_factures'), 'icon', 'receipt', 'entity', 'facture_fournisseur'),
