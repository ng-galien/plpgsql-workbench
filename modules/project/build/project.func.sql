...
END;
$function$;
COMMENT ON FUNCTION project.get_chantier(integer) IS 'Detail chantier : workflow statut, progress avancement, infos, jalons, pointages, notes, equipe, frais';
...
END;
$function$;
COMMENT ON FUNCTION project.get_planning() IS 'Vue planning : chantiers actifs avec progress bar et timeline jalons';
