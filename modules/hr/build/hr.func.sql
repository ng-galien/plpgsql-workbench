...
END;
$function$;
COMMENT ON FUNCTION hr.absence_create(hr.absence) IS 'Create absence — returns inserted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.absence_delete(text) IS 'Delete absence by id — returns deleted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.absence_read(text) IS 'Read absence by id — returns enriched jsonb with employee name';
...
END;
$function$;
COMMENT ON FUNCTION hr.absence_update(hr.absence) IS 'Update absence by id — partial update, returns updated row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.employee_create(hr.employee) IS 'Create employee — returns inserted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.employee_delete(text) IS 'Delete employee by id — returns deleted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.employee_read(text) IS 'Read employee by id — returns enriched jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.employee_update(hr.employee) IS 'Update employee by id — partial update, returns updated row as jsonb';
...
$function$;
COMMENT ON FUNCTION hr.nav_items() IS 'Navigation items for HR module with i18n labels and entity mapping';
...
END;
$function$;
COMMENT ON FUNCTION hr.timesheet_create(hr.timesheet) IS 'Create timesheet entry — returns inserted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.timesheet_delete(text) IS 'Delete timesheet entry by id — returns deleted row as jsonb';
...
END;
$function$;
COMMENT ON FUNCTION hr.timesheet_read(text) IS 'Read timesheet entry by id — returns enriched jsonb with employee name';
...
END;
$function$;
COMMENT ON FUNCTION hr.timesheet_update(hr.timesheet) IS 'Update timesheet entry by id — partial update, returns updated row as jsonb';
