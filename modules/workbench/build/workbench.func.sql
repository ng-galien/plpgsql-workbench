...
END;
$function$;
COMMENT ON FUNCTION workbench.agent_message_read(text) IS 'Read a single message by id with resolved issue info';
...
END;
$function$;
COMMENT ON FUNCTION workbench.issue_report_read(text) IS 'Read a single issue by id with resolved message info';
