-- Auto-generated by pg_pack (cad, cad_ut, cad_qa)
-- 2026-03-11
...
BEGIN
  ...
  v_page_fn := CASE p_current
    WHEN 'Vue 2D' THEN 'drawing'
    WHEN 'Vue 3D' THEN 'drawing_3d'
    WHEN 'Liste de débit' THEN 'drawing_bom'
    ELSE 'drawing'
  END;
  ...
  v_html := '<section>'
    || '<p><select @change="go(''' || v_page_fn || '?p_id='' + $el.value)">'
    || v_options || '</select></p>';
...
AS $function$
  SELECT '[
    {"href": "/", "label": "Accueil"},
    {"href": "/drawing", "label": "2D"},
    {"href": "/drawing_3d", "label": "3D"}
  ]'::jsonb;
$function$;
