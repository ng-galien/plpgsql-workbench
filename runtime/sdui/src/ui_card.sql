CREATE OR REPLACE FUNCTION sdui.ui_card(p_entity_uri text, p_level text, p_header jsonb, p_body jsonb DEFAULT NULL::jsonb, p_related jsonb DEFAULT NULL::jsonb, p_actions jsonb DEFAULT NULL::jsonb)
 RETURNS jsonb
 LANGUAGE sql
 IMMUTABLE
AS $function$
