CREATE OR REPLACE FUNCTION sdui.ui_datasource(p_uri text, p_page_size integer DEFAULT 20, p_searchable boolean DEFAULT false, p_default_sort text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE sql
 IMMUTABLE
AS $function$
