...
export async function scaffoldModule(
  ...
  await fs.mkdir(path.join(moduleDir, "sql"), { recursive: true });
  ...
  // sql/functions.sql (empty placeholder)
  await fs.writeFile(
    path.join(moduleDir, "sql", "functions.sql"),
    `-- Auto-generated by pg_pack (${schemaName})\n-- Functions will be exported here by pg_pack\n`,
  );
